 ...
 * failure path so frontend clients can rely on one shape.
 */
...
public record ApiError(
    ...
    public static ApiError of(int status, String code, String message, String path, List<FieldViolation> fieldErrors) {
